# CodeQL Setup for deepiri-vizult
...
- `.github/workflows/codeql.yml`
  - Defines when scans run and how GitHub Actions executes CodeQL for Ruby code.
...
with:
  languages: ruby
```
This workflow currently runs analysis for Ruby.
...
This workflow currently analyzes Ruby only:
